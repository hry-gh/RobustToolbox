    ...
    impl RenderHandler {
        ...
        fn on_paint(
            ...
            let rects_slice = unsafe {
                std::slice::from_raw_parts(first_rect as *const Rect, dirty_rects_count)
            };

            let mut flat_rects: Vec<i32> = Vec::with_capacity(dirty_rects_count * 4);
